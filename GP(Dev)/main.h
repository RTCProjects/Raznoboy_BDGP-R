...
#ifdef RANGE2
	#define HARDWARE_NUMBER 	1		//аппаратный номер для формирования CanID 0 = range1 1 = range2 2 = range3
#endif

#ifdef RANGE1
	#define HARDWARE_NUMBER 	0		//аппаратный номер для формирования CanID 0 = range1 1 = range2 2 = range3
#endif
